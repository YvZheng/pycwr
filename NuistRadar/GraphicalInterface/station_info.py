...
# Form implementation generated from reading ui file 'F:\Eric\Radar\info.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(340, 273)
        Dialog.setToolTip("")
        Dialog.setSizeGripEnabled(True)
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(70, 190, 75, 31))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(200, 190, 75, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(61, 69, 232, 83))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "天气雷达站点信息输入"))
